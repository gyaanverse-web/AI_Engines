...
STEP_EVALUATION_SYSTEM_INSTRUCTION = (
    ...
    "retrieved context. Evaluate globally before labeling individual steps. Respect block "
    ...
    "unknown, incomplete. step_weight must be between 0 and 1. step_type must be exactly one "
    ...
    "description empty. Every non-empty description must express a complete thought and "
